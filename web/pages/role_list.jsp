                                ...
                                <ul class=" nav nav-subnav">
                                    <c:if test="${not empty menu.list}">
                                        <c:forEach var="menuItem" items="${menu.list}">
                                            <li <c:if test="${menuItem.id==6}">
                                                class="active"
                                            </c:if>
                                            ><a href="${ctx}${menuItem.href}">${menuItem.title}</a></li>
                                        </c:forEach>
                                    </c:if>
                                </ul>
                            </li>
            ...
            <nav class="navbar navbar-default">
                <div class="topbar">
                    ...
                    <div class="topbar-left">
                        ...
                        <span class="navbar-page-title"> 角色管理 : </span>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-toolbar clearfix">
                                ...
                                <div class="toolbar-btn-action">
                                    ...
                                    <a class="btn btn-danger" href="#!"><i class="mdi mdi-window-close" onclick="batchDeleteRole()"></i> 删除</a>
                                </div>
                            </div>
                            <div class="card-body">
 ...
 * */
   function batchDeleteRole() {
    ...
    if (checkedIds1.length > 0){
        if (confirm("确认删除吗？")) {
            $.ajax({
                url: "${ctx}/api/role/batchDeleteRole",
                type: "post",
                dataType: "json",
                data: {
                    ids: checkedIds1
